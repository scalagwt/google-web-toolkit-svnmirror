 ...
 * A view of a tree.
 */
public abstract class CellTreeView extends Composite {
   ...
   */
  private CellTreeViewModel viewModel;
  ...
  public CellTreeView(CellTreeViewModel viewModel) {
    this(viewModel, new SimplePanel());
  }

  protected CellTreeView(CellTreeViewModel viewModel, Widget widget) {
