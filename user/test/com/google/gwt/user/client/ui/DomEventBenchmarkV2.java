...
public class DomEventBenchmarkV2 extends Benchmark {
  ...
  private static final int NUM_WIDGETS = 500;

  protected final IntRange listenerRange = new IntRange(1, 11, Operator.ADD, 4);
  ...
  // Required for JUnit
  public void disabledestSimpleCheckBoxAddAndRemoveForClicks() {
  }
