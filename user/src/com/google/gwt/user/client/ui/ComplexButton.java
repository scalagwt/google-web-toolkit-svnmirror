 ...
 * 
 */
public class ComplexButton extends FocusWidget implements SourcesKeyboardEvents {
  /**
  ...
  public abstract static class State {
    ...
    /**
     * Sets the state's display face as html.
     * 
     * @param html html to set as state's display html
     */
    public final void setFace(String html) {
      face = DOM.createDiv();
      DOM.setInnerHTML(face, html);
      UIObject.setStyleName(face, "html-face", true);
    }
    ...
    private Element getFace() {
      if (face == null) {
        if (delegateTo == null) {
          throw new IllegalStateException("Face is null for a default state");
        } else {
   ...
   */
  public ComplexButton(AbstractImage upImage) {
    this();
   ...
   */
  public ComplexButton(AbstractImage upImage, AbstractImage downImage) {
    this(upImage);
   ...
   */
  public ComplexButton(AbstractImage upImage, ClickListener listener) {
    this(upImage);
   ...
   */
  public ComplexButton(String htmlFace) {
    this();
   ...
   * @param listener the click listener
   */
  public ComplexButton(String htmlFace, ClickListener listener) {
    this(htmlFace);
    addClickListener(listener);
  }
  ...
  /**
   * Sets whether this button is a toggle button. By default all
   * <code>StyleButtons</code> are toggle buttons.
   * 
   * @param isToggleButton is this button a toggle button
   */
